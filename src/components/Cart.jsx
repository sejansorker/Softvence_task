  ...
  return (
    <div className='pt-30'>
        <Container>
            ...
            <div className="flex items-center justify-between gap-y-12 flex-wrap pb-16">
              <div className="w-[32%]">
                <div className="">
              ...
              <div className="w-[32%]">
                <div className="">
                  <img className='pb-6' src={Im5} alt="" />
                  <p className='pb-2 text-[16px] text-[#203F30] font-main font-normal'>$2,100,000</p>
                  <h4 className='pb-6 text-[24px] text-[#0A0915] font-main font-medium'>Spacious 3-Bedroom Townhouse in Toronto, Canada</h4>
                  <img src={Mini5} alt="" />
                </div>
              </div>
            </div>
            <div className="flex justify-center pb-30">
              <button className='text-[16px] bg-[#203F30] font-main font-medium text-white py-3 px-6 rounded-lg cursor-pointer'>Explore All Listings</button>
            </div>
        </Container>
    </div>
  )
