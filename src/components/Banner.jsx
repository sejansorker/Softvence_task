  ...
  return (
    <div className='bg-[url(/banner.png)] bg-cover bg-center bg-no-repeat pt-[213px] pb-[279px]'>
        <Container>
          ...
          <h2 className='text-[80px] text-white font-main font-normal leading-[114px]'>Turning Your Real Estate Dreams into Reality</h2>
          <p className='pt-2.5 pb-10.5 text-[20px] text-white font-main  font-normal w-[696px]'>Forget clunky application forms. We offer a modern, user-friendly platform that makes applying for a job a breeze.</p>
